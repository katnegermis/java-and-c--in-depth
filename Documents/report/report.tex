...
% Michael's notes:
% Integration of `bplusdotnet' into our project:
% - Implement JCDFileStream : Stream to let `bplusdotnet' use our file system instead of host file system.
% - Write wrapper layer (`vfs.core.indexing')
%     - In this wrapper layer
% - Modify `bplusdotnet' to allow for case sensitive search.
%     - possibly upload source code
...
%\emph{Give a short (1-2 paragraphs) description of what Synchronization Server is.}
%
%
%\subsection{Requirements}
%
